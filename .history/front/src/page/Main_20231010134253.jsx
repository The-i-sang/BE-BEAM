...
export default function Main() {
  return (
    <div className="w-8/12 mx-auto bg-[#fff]">
      <div className="w-full h-[400px] mt-6 rounded-xl my-custom-bg-class bg-fill bg-fixed bg-no-repeat bg-[center_bottom_6rem] text-white flex flex-col justify-center items-center relative">
        <div className="w-full h-full bg-black opacity-20 rounded-xl absolute top-0 left-0" />
        ...
        <div className="w-full pt-7">
          ...
          <div className="w-full mt-14">
            <div className="w-full">
              <div className="w-6/12 mb-60 flex flex-col items-center group text-[#282828] text-center">
                <img
              ...
              <div className="w-full mb-60 flex flex-col items-center group text-[#282828] text-center">
                ...
                <h1 className="text-[2.625rem] font-semibold mt-[1rem]">
                  The 이상의{" "}
                  <span className="text-white text-stroke">목적</span>은?
                </h1>
                <p className="mt-[2rem] text-[1.125rem]">
            ...
            <div className="w-5/12">
              <div className="w-full mb-60 flex flex-col items-center group text-[#282828] text-center">
                ...
                <h1 className="text-[2.625rem] font-semibold mt-[1rem]">
                  The 이상의{" "}
                  <span className="text-white text-stroke">비전</span>은?
                </h1>
              ...
              <div className="w-full mb-60 flex flex-col items-center group text-[#282828] text-center">
                ...
                <h1 className="text-[2.625rem] font-semibold mt-[1rem]">
                  The 이상의{" "}
                  <span className="text-white text-stroke">가치</span>는?
                </h1>
                <ul className="mt-[2rem] text-[1.125rem] text-left">
                  ...
                  <li className="mb-4">
                    <span className="text-[#f5aa15]">ODD</span> - 이상한,
                    특이한: <br />
                  ...
                  <li className="mb-4">
                    <span className="text-[#f5aa15]">ACTION</span> - 행동:{" "}
                    <br />
