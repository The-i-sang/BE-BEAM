      ...
      <div className="w-full max-w-[1400px] mx-auto flex flex-col items-center">
        ...
        >
          <input
            ...
            value={text}
            className="w-full p-8 box-border mt-4 rounded-full dark:bg-transparent border-[1px] border-solid border-[#79B1FF] outline-none text-[1.2rem] placeholder:text-[1.2rem] placeholder:text-[#79B1FF]"
            type="text"
