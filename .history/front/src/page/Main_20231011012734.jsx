        ...
        <div className="w-11/12 mx-auto pt-32">
          ...
          <div className="w-full mb-32 flex items-center group text-[#282828] text-center">
            <div className="w-6/12 p-14 box-border flex flex-col items-start">
              ...
              <ul className="text-[1rem] text-left leading-7">
                <li className="mb-4">
                  <span className="text-[#f5aa15]">
                    연결망 (SOCIAL NETWORK)
                  </span>{" "}
                ...
                <li className="mb-4">
                  <span className="text-[#f5aa15]">청년 (YOUTH)</span> : 청년의
                  주체성 있는 사회참여활동을 기반으로 합니다.
                </li>
                <li className="mb-4">
                  <span className="text-[#f5aa15]">행동 (ACTION)</span> :
                  주체성이 담긴 행동을 통해서 사회 구성원의 인식 및 행동의
                  변화를 이끌어냅니다.
                </li>
                <li className="mb-4">
                  <span className="text-[#f5aa15]">공감 (SYMPATHY)</span> : 사회
                  구성원에 대한 공감대를 기반으로 서로에게 즐겁고, 따뜻한 활동을
                  진행합니다.
                </li>
                <li className="mb-4">
                  <span className="text-[#f5aa15]">안정 (STABILITY)</span> :
            ...
            <img className="w-6/12 object-cover" src={img3} alt="intro_img" />
          </div>
        </div>
      </div>
    </div>
