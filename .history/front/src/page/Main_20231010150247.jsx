    ...
    <div className="w-full mx-auto mt-4">
      <div className="w-full h-[902px] relative">
        ...
        <div
          ...
          } mx-auto h-[720px] my-custom-bg-class bg-cover bg-fixed bg-no-repeat bg-[center_bottom_0] text-white flex flex-col justify-center items-center relative top-10 transition-all duration-700`}
        >
