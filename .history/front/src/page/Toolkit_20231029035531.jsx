                  ...
                  <div
                    className={`${
                      cate.isActive
                        ? "bg-black dark:bg-white"
                        : "bg-transparent"
                    } w-[65px] h-[65px] rounded-full border-[1px] group-hover:bg-black dark:group-hover:bg-white border-solid border-[#393939] flex justify-center items-center transition-all duration-700`}
                  >
                    {cate.title === "All" ? (
                      <p
                        className={`${
