...
export default function Main() {
  return (
    <div className="w-6/12 mx-auto bg-[#fff]">
      <div className="w-full h-[400px] mt-6 rounded-xl my-custom-bg-class bg-cover bg-fixed bg-no-repeat text-white flex flex-col justify-center items-center">
        <h1 className="text-[3rem]">The 이상</h1>
        <p className="text-[1.8rem] mb-24">이상한 사회를 이상적인 사회로</p>
      </div>
