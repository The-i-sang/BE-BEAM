...
export default function Main() {
  ...
  return (
    <div className="w-full mx-auto mt-4">
      <div className="w-full relative bg-lime-200">
        <div
          className={`${
            scrollHeight > 100
              ? "absolute top-[22rem] text-white"
              : "absolute top-0"
          } w-full h-[300px] text-center bg-teal-400 transition-all duration-1000 z-[9999] flex flex-col justify-center items-center`}
        >
        ...
        <div
          className={`${
            scrollHeight > 100 ? "w-full top-40" : "w-11/12 top-[300px]"
