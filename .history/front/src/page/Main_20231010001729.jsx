...
export default function Main() {
  return (
    <div className="w-8/12 mx-auto bg-[#fff]">
      <div className="w-full h-[400px] mt-6 rounded-xl bg-black bg-opacity-50 text-white flex flex-col justify-center items-center relative">
        <div className="w-full h-[400px] my-custom-bg-class bg-cover bg-fixed bg-no-repeat bg-[center_bottom_0rem] rounded-xl absolute top-0 left-0 z-[-999]" />
