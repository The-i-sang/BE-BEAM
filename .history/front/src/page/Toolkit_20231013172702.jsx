  ...
  return (
    <div className="w-full bg-[#ffffff] pt-16">
      <div className="w-full max-w-[1400px] mx-auto flex flex-col justify-between items-center font-medium">
        ...
        <div className="w-full max-w-[1400px] mx-auto pb-6 mt-36 flex">
          ...
          <ul className="flex-grow-0 flex text-5xl font-medium text-[#ff3e4f]">
          ...
          <ul className="flex-1 flex text-5xl font-medium text-[#79B1FF]">
