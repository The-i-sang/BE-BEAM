  ...
  return (
    <div className="w-full mx-auto mt-4">
      <div className="w-full h-[1020px] relative bg-orange-300">
        <div
          className={`${
            scrollHeight > 100 ? "absolute top-[22rem]" : "absolute top-0"
          } w-full h-[300px] text-center transition-all duration-700 z-[9999] flex flex-col justify-center items-center`}
        >
        ...
        <div
          className={`${
            scrollHeight > 100 ? "w-full top-40" : "w-11/12 top-100"
