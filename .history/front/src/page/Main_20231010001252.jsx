...
export default function Main() {
  return (
    <div className="w-8/12 mx-auto bg-[#fff]">
      <div className="w-full h-[400px] mt-6 rounded-xl my-custom-bg-class bg-cover bg-fixed bg-no-repeat bg-[center_bottom_-7rem] text-white flex flex-col justify-center items-center">
