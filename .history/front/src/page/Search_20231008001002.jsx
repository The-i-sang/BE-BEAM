    ...
    if (trimmedText !== "") {
      setSearchToolkits(
        toolkits.filter((toolkit) => {
          const trimTitle = toolkit.title.trim();
          const trimDescription = toolkit.description.trim();

          return (
            trimTitle.includes(text) ||
            trimDescription.includes(text) ||
            toolkit.title.includes(text) ||
            toolkit.description.includes(text)
          );
        })
      );
