...
export default function Main() {
  return (
    <div className="w-11/12 mx-auto bg-[#fff]">
      <div className="w-full h-[720px] mt-6 my-custom-bg-class bg-cover bg-fixed bg-no-repeat bg-[center_bottom_0] text-white flex flex-col justify-center items-center relative">
