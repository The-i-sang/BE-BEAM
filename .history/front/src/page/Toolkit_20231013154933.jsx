              ...
              return (
                ...
                >
                  <div
                    ...
                    } w-[65px] h-[65px] rounded-full border-[1px] group-hover:bg-black border-solid border-[#FDBA74] flex justify-center items-center transition-all duration-700`}
                  >
                    {cate.title === "All" && (
                      <p
                        className={`${
                  ...
                  <p
                    className={`${
                      cate.isActive ? "text-[#f58515]" : "text-[#FDBA74"
