...
export default function Toolkit() {
  ...
  const handleCategoryClick = (clickedCategory) => {
    ...
    if (searchToolkits.length === 0 && category2 === "" && category3 === "") {
      setCategories2((prev) =>
        prev.map((category) => {
          if (category2.title === "All") {
  ...
  const handleCategoryClick2 = (clickedCategory) => {
    ...
    if (searchToolkits.length === 0 && category === "" && category3 === "") {
      setCategories((prev) =>
        prev.map((category) => {
  ...
  const handleCategoryClick3 = (clickedCategory) => {
    ...
    if (searchToolkits.length === 0 && category === "" && category2 === "") {
      setCategories((prev) =>
        prev.map((category) => {
          if (category.title === "All") {
            return { ...category, isActive: true };
