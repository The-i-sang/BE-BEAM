...
export default function Main() {
  return (
    <div className="w-11/12 mx-auto mt-10 bg-[#cb8a8a]">
      <div className="w-full h-[720px] my-custom-bg-class bg-cover bg-fixed bg-no-repeat bg-[center_bottom_0] text-white flex flex-col justify-center items-center relative">
