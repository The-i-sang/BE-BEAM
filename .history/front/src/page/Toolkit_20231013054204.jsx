  ...
  return (
    <div className="w-full bg-[#ffffff] pt-16">
      <div className="w-full max-w-[1400px] mx-auto flex flex-col justify-between items-center font-medium">
        ...
        <input
          className="w-full max-w-[760px] p-8 box-border mt-4 rounded-full border-[1px] border-solid border-[#79B1FF] outline-none text-[1.2rem] placeholder:text-[1.2rem] placeholder:text-[#999999]"
          type="text"
