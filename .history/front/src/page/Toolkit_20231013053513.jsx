...
export default function Toolkit() {
  ...
  return (
    <div className="w-full bg-[#ffffff] pt-16">
      <div className="w-full max-w-[1400px] mx-auto flex flex-col justify-between items-center font-medium text-[#f5aa15]">
        ...
        <input
          className="w-full max-w-[760px] p-8 box-border mt-4 rounded-full border-[1px] border-solid border-[#222] outline-none"
          type="text"
        ...
        <ul className="2xl:w-full xl:w-11/12 lg:w-full md:w-[94%] sm:w-[97%] w-[86%] mx-auto md:pt-14 sm:pt-10 pt-10 flex flex-wrap [&>*:last-child]:ml-0 text-[#282828]">
          {filteredToolkits &&
