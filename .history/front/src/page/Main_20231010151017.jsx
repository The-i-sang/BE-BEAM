...
export default function Main() {
  ...
  return (
    <div className="w-full mx-auto mt-4">
      <div className="w-full h-[1020px] relative bg-orange-300">
        <div
          className={`${
            scrollHeight > 100 ? "absolute top-[28rem]" : ""
          } w-full h-[300px] bg-red-300 text-center  transition-all duration-700 z-[9999]`}
        >
        ...
        <div
          className={`${
            scrollHeight > 100 ? "w-full top-40" : "w-11/12"
          } mx-auto h-[720px] my-custom-bg-class bg-cover bg-fixed bg-no-repeat bg-[center_bottom_0] text-white flex flex-col justify-center items-center relative transition-all duration-700`}
        >
