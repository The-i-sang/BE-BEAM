...
export default function ActivityDetail() {
  ...
  return (
    <div className="w-full pt-10">
      ...
      <div className="w-full fixed bottom-0 left-0 flex justify-center items-center">
        <div className="w-full min-w-[760px] p-4 box-border border-[1px] border-solid border-[#b0b0b0] rounded-lg">
          {activity.price === 0 ? (
            <div>
              <h1>월 0원</h1>
              <p>무료</p>
            ...
            <div>
              <h1>월 {activity.price}원</h1>
              <p>월 {activity.price}원</p>
            </div>
          )}
        </div>
      </div>
