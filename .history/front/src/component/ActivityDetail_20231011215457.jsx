    ...
    <div className="w-11/12 mx-auto pt-2">
      <div className="w-full">
        ...
        <ul className="w-full flex items-center">
          <li className="w-1/3 flex items-center gap-x-4 border-r-[1px] border-solid border-[#666]">
            <FaLocationDot />
            <p>{activity.place}</p>
          </li>
          <li className="w-1/3 px-8 box-border border-r-[1px] border-solid border-[#666] flex items-center">
            <BsFillCalendarCheckFill />
            <p>{activity.schedule}</p>
          </li>
          <li className="w-1/3 px-8 box-border flex items-center">
            <BsPersonFill />
            <p>{activity.member}</p>
          </li>
        </ul>
