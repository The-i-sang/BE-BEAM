...
export default function ActivityCard({ activity }) {
  ...
  return (
    <li className="w-full">
      <img
        className="w-full object-cover object-center absolute top-0 left-0 z-[0]"
        src={process.env.PUBLIC_URL + `${activity.thumbnail}`}
        alt="activity_img"
      />
      <div className="w-full bg-[rgba(0,0,0,0.6)] absolute top-0 left-0 flex flex-col items-center justify-center z-[99]">
