      ...
      <li
        ...
        className={`${
          path === "/"
            ...
            : "before:opacity-0"
        } w-1/5 py-2 before:absolute before:-inset-1 before:-skew-y- before:bg-orange-300 hover:before:opacity-100 relative inline-block cursor-pointer hover:font-semibold hover:text-white transition-all duration-700 before:transition-all before:duration-700`}
      >
