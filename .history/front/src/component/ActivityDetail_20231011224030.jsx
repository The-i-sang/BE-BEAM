  ...
  return (
    <div className="w-11/12 mx-auto pt-2">
      <div className="w-full">
        ...
        <ul className="w-full mt-6 flex items-center text-[1.14rem] text-[#616161]">
          ...
          <li className="w-1/4 px-8 box-border border-r-[1px] border-solid border-[#DADCE0] flex items-center gap-x-4">
          ...
          <li className="w-1/4 px-8 box-border flex items-center gap-x-4">
            <BsPersonFill className="text-[1.8rem] text-[#282828]" />
            <p>{activity.member}</p>
          </li>
        </ul>
