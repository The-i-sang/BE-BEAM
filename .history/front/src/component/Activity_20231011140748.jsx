              ...
              >
                <div className="flex flex-col items-center">
                  <div
                    className={`${
                      cate.isActive
                        ? "bg-gradient-to-r from-[#e5785d] to-[#ffc66f]"
                        : "bg-transparent"
                    } w-[65px] h-[65px] rounded-full border-[1px] group-hover:bg-gradient-to-r group-hover:from-[#e5785d] group-hover:to-[#ffc66f] border-solid border-[#F5AA15] flex justify-center items-center transition-all duration-700`}
                  >
                    {cate.title === "All" ? (
                      <p
                        className={`${
                          cate.isActive ? "text-white" : "[#F5AA15]"
                      ...
                      <p
                        className={`${
                          cate.isActive ? "text-white" : "text-[#F5AA15]"
                        } text-[1.2rem]`}
                      >
                        <BsSendCheck />
                      </p>
