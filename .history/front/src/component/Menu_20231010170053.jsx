...
export default function Menu({ path }) {
  ...
  return (
    <ul className="w-5/12 flex justify-between text-[#344054] text-[20px]">
      <li
        onClick={() => {
          navigate("/");
        }}
        className={`${
          path === "/"
            ...
            : "before:opacity-0"
        } w-1/5 py-1 before:absolute before:-inset-1 before:-skew-y-3 before:bg-orange-300 hover:before:opacity-100 relative inline-block cursor-pointer hover:font-semibold hover:text-white transition-all duration-700 before:transition-all before:duration-700`}
      >
