  ...
  return (
    <div className="w-full py-16">
      <div className="w-11/12 mx-auto">
        ...
        <ul className="w-full mt-36 pb-10 border-b-[1px] border-solid border-[#282828] flex items-center text-5xl font-medium text-[#f5aa15]">
          {categories.map((cate) => {
            return (
              <li
                key={cate.title}
      ...
      <div className="bg-[#FDBA74]">
        <ul className="w-11/12 mx-auto mt-10 grid grid-cols-2 gap-x-6 gap-y-6">
          {filteredActivities &&
