  ...
  return (
    <ul className="w-4/12 h-[80px] flex justify-between text-[#344054] text-[20px]">
      <li
        ...
        } w-1/5 before:absolute before:-inset-1 before:-skew-y-3 before:bg-pink-500 relative inline-block  after:content-['*'] after:ml-0.5 after:text-red-500 after:opacity-0 hover:after:opacity-100 cursor-pointer hover:font-semibold transition-all duration-700 flex items-center`}
        onClick={() => {
          navigate("/");
        }}
      >
