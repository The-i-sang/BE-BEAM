  ...
  return (
    <div className="w-11/12 mx-auto pt-2">
      ...
      <div className="w-full mt-14 flex">
        <img
          className="w-[40%] h-[360px] object-cover object-center"
          src={process.env.PUBLIC_URL + `/../${activity.thumbnail}`}
          alt="img"
        />
        <div className="w-[60%] px-10 box-border">
          <p className="font-semibold">{activity.subTitle}</p>
          <p className="mt-4 whitespace-pre-line">{activity.description}</p>
        </div>
      </div>
