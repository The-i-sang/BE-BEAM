...
export default function ActivityDetail() {
  ...
  return (
    <div className="w-full pt-10">
      ...
      <div className="w-full bg-transparent border-b-[1px] border-solid border-[#d0d0d0] relative">
        <div className="w-full h-40 bg-[#f6f6f6] absolute bottom-0 left-0 z-[-999]"></div>
        ...
        <div className="w-11/12 mx-auto py-14">
          ...
          <ul className="w-full grid grid-cols-5 gap-x-3 z-[999]">
            {activity.image &&
