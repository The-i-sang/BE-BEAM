  ...
  return (
    <ul className="w-4/12 flex justify-between text-[#344054] text-[20px]">
      ...
      <li
        ...
        } w-1/5 py-1 before:opacity-0 before:absolute before:-inset-1 before:-skew-y-3 before:bg-pink-500 hover:before:opacity-100 relative inline-block cursor-pointer hover:font-semibold hover:text-white transition-all duration-700 before:transition-all before:duration-700`}
      >
