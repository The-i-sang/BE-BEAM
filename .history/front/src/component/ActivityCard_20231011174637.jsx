  ...
  return (
    ...
    >
      ...
      <div className="w-3/4 flex flex-col justify-between">
        ...
        <div>
          <h1 className="mb-3 text-[#383535] text-[1.3rem] font-semibold whitespace-nowrap overflow-hidden text-ellipsis">
            {activity.title}
          </h1>

          <p className="mb-4 text-[0.9rem] text-[#555]">
            {activity.state} · {activity.schedule}
          </p>
          <div className="flex items-center">
            <IoLocationOutline className="text-red-700 text-[1.4rem]" />
            <p className="text-[0.9rem]">{activity.place}</p>
          </div>
        </div>
      </div>
    </li>
