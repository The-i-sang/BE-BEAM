              ...
              >
                <div className="flex flex-col items-center">
                  <div
                    className={`${
                      cate.isActive
                        ? "bg-black dark:bg-[#fff3e6]"
                        : "bg-transparent"
                    } w-[65px] h-[65px] rounded-full border-[1px] group-hover:bg-black dark:group-hover:bg-[#fff3e6] border-solid border-[#393939] dark:border-white flex justify-center items-center transition-all duration-700`}
                  >
                    {cate.title === "All" ? (
                      <p
                        className={`${
