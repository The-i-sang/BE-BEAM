  ...
  return (
    <div className="w-full py-16">
      <div className="w-full mx-auto">
        ...
        <ul className="w-full bg-lime-500 flex justify-between items-center text-5xl font-medium text-[#f5aa15]">
          {categories.map((cate) => {
            return (
              <li
                key={cate.title}
              ...
              >
                <div>
                  <div className="w-[65px] h-[65px] rounded-t-full border-[1px] border-solid border-[#282828]">
                    {cate.title === "All" ? <p>ALL</p> : ""}
                  </div>
                  <p>{cate.title}</p>
                </div>
              </li>
