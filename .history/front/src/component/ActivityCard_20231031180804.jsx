...
export default function ActivityCard({ activity }) {
  ...
  return (
    <li
      ...
      className="cursor-pointer w-full p-4 box-border bg-[rgba(255,255,255,0.1)] rounded-xl border-[1px] border-solid border-white flex gap-x-4"
    >
      <img
      ...
      <div className="w-3/4">
        ...
        <div className="mt-4">
          <h1 className="mb-2 text-[#383535] dark:text-[#ffaa15] text-[1.3rem] font-semibold whitespace-nowrap overflow-hidden text-ellipsis">
            {activity.title}
          </h1>

          <p className="mb-2 text-[0.9rem] text-[#555] dark:text-[rgba(255,255,255,0.7)]">
            {activity.state} · {activity.schedule}
          </p>
          <div className="flex items-center">
            <FaLocationDot className="text-[#282828] dark:text-[#ff2121] text-[1.3rem]" />
            <p className="text-[0.9rem] text-[#282828] dark:text-white">
              {activity.place}
            </p>
          </div>
        </div>
