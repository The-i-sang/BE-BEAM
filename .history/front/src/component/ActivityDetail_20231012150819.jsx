...
export default function ActivityDetail() {
  ...
  return (
    <div className="w-full pt-10">
      ...
      <div className="w-full fixed bottom-10 left-0 flex justify-center items-center">
        <div className="w-full max-w-[760px] p-4 box-border border-[1px] border-solid border-[#b0b0b0] rounded-lg">
          <div>
