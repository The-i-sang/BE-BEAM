              ...
              >
                <div className="flex flex-col items-center">
                  <div
                    ...
                    } w-[65px] h-[65px] rounded-full border-[1px] group-hover:bg-gradient-to-r group-hover:from-[#e5785d] group-hover:to-[#ffc66f] border-solid border-[#282828] flex justify-center items-center transition-all duration-700`}
                  >
                    {cate.title === "All" ? (
                      <p
                        className={`${
