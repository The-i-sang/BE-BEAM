              ...
              >
                <div className="flex flex-col items-center">
                  ...
                  <p
                    ...
                    } mt-2 text-[1rem] [#F5AA15] group-hover:text-[#f58515] group-hover:font-semibold transition-all duration-700 group-hover:transition-all group-hover:duration-700`}
                  >
                    {cate.title}
                  </p>
                </div>
