            ...
            return (
              <li
                ...
                className={`cursor-pointer pb-2 border-b-[4px] border-[rgba(196,137,18,0)] border-solid ${
                  cate.isActive ? "text-[rgba(196,137,18,100)]" : ""
                } mr-4 hover:border-[rgba(196,137,18,100)] hover:text-[rgba(196,137,18,100)] transition-all duration-700`}
              >
                <div className="flex flex-col items-center">
                  ...
                  <p className="mt-2 text-[1rem] text-[#282828] hover:text-[#f5aa15]">
                    {cate.title}
                  </p>
                </div>
              </li>
