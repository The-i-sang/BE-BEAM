            ...
            return (
              ...
              >
                <div className="flex flex-col items-center">
                  <div
                    className={`${
                      cate.isActive ? "bg-[#f5aa15]" : "bg-transparent"
                    } w-[65px] h-[65px] rounded-full border-[1px] border-solid border-[#282828] flex justify-center items-center`}
                  >
                    {cate.title === "All" ? (
                      <p className="text-[1.2rem] text-[#282828]">ALL</p>
                    ) : cate.title === "모집 중" ? (
                      <p className="text-[1.2rem] text-[#282828]">
                        <BsSendCheck />
                      </p>
                    ) : (
                      <p className="text-[1.2rem] text-[#282828]">
