...
export default function ActivityDetail() {
  ...
  return (
    <div className="w-full pt-10">
      ...
      <div className="w-full border-b-[1px] border-solid border-[#f6f6f6] flex gap-x-10">
      ...
      <div className="w-full w-full border-b-[1px] border-solid border-[#f6f6f6] flex gap-x-10"></div>
