  ...
  return (
    <ul className="w-4/12 h-[80px] flex justify-between text-[#344054] text-[20px]">
      <li
        className={`${
          path === "/"
            ? "underline underline-offset-[16px] decoration-[3px] decoration-black font-semibold"
            : ""
        } w-1/5 underline- underline-offset-[16px] decoration-[3px] cursor-pointer hover:font-semibold transition-all duration-700 flex items-center`}
        onClick={() => {
          navigate("/");
        }}
      >
