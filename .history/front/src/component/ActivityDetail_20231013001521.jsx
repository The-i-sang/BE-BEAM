    ...
    <div className="w-full pt-10">
      ...
      <div className="w-full border-b-[1px] border-solid border-[#d0d0d0] flex gap-x-10">
        <div className="w-11/12 mx-auto py-14 flex ">
          ...
          <ul>
            ...
            <li className="mt-10 flex items-center gap-x-2">
              <FaLocationDot className="text-[1.8rem] text-[#d46e6e]" />
              <p className="mt-2 text-[1rem]">{activity.place}</p>
            </li>
      ...
      <div className="w-full bg-transparent relative">
        ...
        <div className="w-11/12 mx-auto py-14">
          ...
          <p>사진을 통해서 모임과 한 발자국 더 가까워지기!</p>

          <ul className="w-full grid grid-cols-5 gap-x-3 gap-y-3">
            {activity.image &&
      ...
      <div className="w-full fixed bottom-6 left-0 flex justify-center items-center">
        <div className="w-full max-w-[760px] p-4 box-border bg-white border-[1px] border-solid border-[#b0b0b0] rounded-lg">
          <div>
