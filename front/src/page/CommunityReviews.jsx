...
export default function CommunityReviews() {
  ...
  const handleSearchData = (e) => {
    ...
    if (searchText.length > 0 && trimmedSearchTerm === "") {
      ...
      const filteredResults = filtered.filter((data) =>
        data?.text.replace(/\s+/g, "").toLowerCase().includes(refinedSearchTerm)
      );
        ...
        <div className="relative w-full">
          ...
          <div className="w-full mt-10">
            <div className="w-full">
              ...
              <div className="flex items-center w-full py-5 border-b-[1px] border-solid border-[#e1e5e9]">
                <div className="w-[190px] py-4 pr-12 box-border flex items-center gap-x-4 text-[3.4rem] font-bold border-r-[2px] border-solid border-[#dadada]">
                  <img
                    className="w-12 h-12"
                ...
                <div className="box-border flex flex-col justify-center pl-12">
                  <p>
                    현재까지
              ...
              <div className="w-full py-5 border-b-[1px] border-solid border-[#e1e5e9]">
                <SearchInputForm
