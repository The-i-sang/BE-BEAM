    ...
    <div className="w-full py-10 bg-[#ffffff] dark:bg-black">
      <div className="w-11/12 max-w-[1400px] mx-auto">
        ...
        <div className="w-full flex md:flex-row sm:flex-col flex-col md:items-start md:justify-between">
          ...
          <div className="lg:w-w-1calc md:w-w-2calc sm:w-full w-full md:px-6 sm:px-0 px-0 md:py-0 sm:py-14 py-14 box-border text-[#282828] dark:text-white font-normal">
