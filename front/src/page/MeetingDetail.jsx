...
import MeetingApplyReasonModal from "../component/MeetingApplyReasonModal";
  ...
  return (
    <div className="w-full pt-10 dark:bg-black dark:text-white font-light">
      ...
      <div className="w-full border-b-[1px] border-solid border-[#d0d0d0] dark:border-[#444] flex gap-x-10">
        <div className="w-11/12 sm:max-w-[90%] mx-auto sm:py-14 pt-5 pb-10 flex sm:flex-row flex-col">
