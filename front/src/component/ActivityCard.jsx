...
export default function ActivityCard({ activity }) {
  ...
  return (
    ...
    <li
      ...
      className="cursor-pointer w-full h-full sm:mb-0 mb-5 p-4 box-border bg-[rgba(255,255,255,0.1)] rounded-xl border-[1px] border-solid border-white flex md:flex-row sm:flex-col flex-col"
    >
      ...
      <div className="lg:w-1calc md:w-2calc md:px-4 sm:px-0 px-0 md:py-0 sm:py-4 py-4 box-border">
        ...
        <div className="heart" onClick={handleClick}>
          {isClicked ? <GoHeartFill style={{ fontSize: "28px" }} /> : <GoHeart style={{fontSize: "28px" }} />}
        </div>         
