                ...
                <li className="w-full h-[720px] mt-10 relative">
                  ...
                  <div className="w-full h-full bg-[rgba(0,0,0,0.6)] absolute top-0 left-0 flex flex-col items-center justify-center z-[99]">
                    ...
                    <div className="text-white text-[1.1rem] flex">
                      ...
                      <button
                        className="w-[20rem] py-3 ml-8 bg-black bg-opacity-100 border-[1px] border-solid border-black flex items-center justify-center hover:bg-opacity-0 hover:border-none transition-all duration-700"
                        type="button"
                      >
                        인스타 보러가기
                      </button>
