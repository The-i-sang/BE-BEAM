    ...
    >
      <div className="relative group">
        <img
          ...
          alt="toolkit_img"
        />
        <div className="group-hover:h-24 group-hover:shadow-[0_-14px_12px_-2px_rgba(0,0,0,0.1)] absolute bottom-0 w-full h-0 bg-[rgba(255 217 142, 0.6)] rounded-b-lg flex justify-center items-center text-xl transition-all duration-700 overflow-hidden">
          <p>자세히 보기</p>
        </div>
      </div>
