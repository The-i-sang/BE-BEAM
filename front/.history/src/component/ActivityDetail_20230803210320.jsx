    ...
    <div className="w-full py-[120px]">
      ...
      <div className="w-1/2 mx-auto pt-[160px]">
        ...
        <div className="mt-[120px]">
          <button
            className="w-[20rem] py-3 bg-black bg-opacity-0 border-[1px] border-solid border-black flex items-center justify-center hover:bg-opacity-100 hover:border-black hover:text-white transition-all duration-700"
            type="button"
          >
            목록보기
          </button>
