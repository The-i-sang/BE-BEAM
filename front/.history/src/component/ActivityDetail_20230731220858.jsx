...
export default function ActivityDetail({ setCategoryOn }) {
  ...
  return (
    <div className="w-full py-[120px]">
      <div className="w-full h-[720px] bg-orange-600 relative">
        <div>
          <img
            ...
            alt="img"
          />
          <div className="w-full h-full bg-[rgba(0,0,0,0.3)] absolute top-0 left-0 flex flex-col items-center justify-center z-[99]">
