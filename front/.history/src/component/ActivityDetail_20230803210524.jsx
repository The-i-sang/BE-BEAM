    ...
    <div className="w-full py-[120px]">
      ...
      <div className="w-1/2 mx-auto pt-[160px]">
        ...
        <div className="w-full mt-[120px] flex justify-between">
          ...
          <button
            className="w-[48%] py-3 bg-black bg-opacity-100 border-[1px] border-solid border-black flex items-center justify-center hover:bg-opacity-0 hover:border-black hover:text-black transition-all duration-700"
            type="button"
          >
            신청하기
          </button>
