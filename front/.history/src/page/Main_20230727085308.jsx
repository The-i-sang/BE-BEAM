  ...
  return (
    <div className="bg-[#ffeaa6] pt-32">
      ...
      <div className="w-full h-[780px] my-custom-bg-class bg-cover bg-fixed bg-no-repeat text-white flex flex-col justify-center items-center">
        ...
        <p className="text-[2.4rem] mb-24">
          이상한 사회를 <span className="text-stroke">이상적인 사회</span>로
        </p>
      </div>
      ...
      <div className="w-11/12 mx-auto pb-32">
        <div className="w-full pt-10">
          <h2 className="text-[4rem] text-[#282828] font-semibold text-center">
            이상한 사회를{" "}
            <span className="text-transparent text-stroke">이상적인 사회</span>
            로
          </h2>

          <div>
            <div>
              <img src={img5} alt="intro_img" />
            ...
            <div>
              ...
              <p>THE 이상은 오프라인 및 온라인을 기반으로 활동을 진행합니다.</p>
              <ul>
                <li>
                ...
                <li>
                  청년들이 사회문제에 관심을 가지도록 연구, 각종 콘텐츠를 제작할
                  예정입니다.
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul>
                ...
                <li>
                  ACTION - 행동: 주체성이 담긴 행동을 통해서 사회 구성원의 인식
                  및 행동의 변화를 이끌어냅니다.
                </li>
                <li>
                  SYMPATHY - 공감: 사회 구성원에 대한 공감대를 기반으로 서로에게
                  즐겁고, 따뜻한 활동을 진행합니다.
                </li>
              </ul>
            </div>
