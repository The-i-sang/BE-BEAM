                ...
                >
                  <div className="relative group">
                    <img
                      ...
                      alt="toolkit_img"
                    />
                    <div className="group-hover:h-24 absolute bottom-0 w-full h-0 bg-[rgba(255,225,129,0.91)] rounded-b-lg flex justify-center items-center text-xl transition-all duration-700 overflow-hidden">
                      <p>자세히 보기</p>
                    </div>
                  </div>
