        ...
        <div className="w-full pt-7">
          ...
          <div className="w-full mt-32 flex justify-between">
            <div className="w-5/12">
              <div className="w-full mb-60 flex flex-col items-center group text-[#282828]">
                <img
              ...
              <div className="w-full mb-60 flex flex-col items-center group text-[#282828] text-center">
                ...
                <ul className="mt-[2rem] text-[1.125rem] text-left">
                  ...
                  <li>
                    ...
                    특이한: 이상하지만 특이한 우리들만의 방식으로 사회문제를
                    바라보고, 해결하고자 합니다.
                  </li>
                  <li>
                    <span className="text-[#f5aa15]">YOUTH</span> - 청년: 청년의
                    주체성 있는 사회참여활동을 기반으로 이상적인 사회로
                    나아갑니다.
                  </li>
                  <li>
