  ...
  return (
    <div className="bg-[#ffeaa6] min-h-[1200px]">
      <div className="w-11/12 mx-auto py-32">
        <div className="w-full h-[700px] bg-[url('https://images.unsplash.com/photo-1553877522-43269d4ea984?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80')] bg-fixed">
