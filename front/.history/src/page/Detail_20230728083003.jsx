      ...
      <div className="w-11/12 mx-auto py-10 flex justify-between">
        ...
        <div className="w-5/12 text-[#282828]">
          ...
          {selectedToolkit && !isNaN(recommendIndex) && (
            <div
              onClick={() => {
                `/detail/${selectedToolkit[recommendIndex].id}`, { state: { selectedToolkit[recommendIndex] }
              }}
              className="w-full py-10 box-border flex justify-between items-center text-[#282828]"
            >
              <img
