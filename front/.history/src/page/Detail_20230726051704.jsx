      ...
      <div className="w-11/12 mx-auto py-10 flex justify-between">
        ...
        <div className="w-5/12 text-[#282828]">
          ...
          <a
            ...
            target="_blank"
            className="pb-20 border-b-[1px] border-solid border-[#f5aa15]"
          >
            <button
              className="w-full p-6 box-border flex justify-center items-center bg-[#282828] text-[1.2rem] text-white ml-6"
              type="button"
