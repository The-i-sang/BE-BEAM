...
export default function Main({ setCategoryOn }) {
  ...
  const textShadow =
    "-1px_-1px_0_#f5aa15, 1px_-1px_0_#f5aa15, -1px_1px_0_#f5aa15, 1px_1px_0_#f5aa15";
        ...
        <div className="w-full pt-7">
          ...
          <div className="w-full mt-32 flex justify-between">
            <div className="w-5/12">
              <div className="w-full mb-60 flex flex-col items-center group">
                <img
                ...
                <h1 className="text-[2.625rem] font-semibold mt-[1rem]">
                  THE{" "}
                  <span className="text-white group-hover:drop-shadow-[0_1px_1px_#f5aa15]">
                    (더)
                  </span>
                  +이상
                </h1>
