  ...
  return (
    <div className="bg-[#ffeaa6] pt-32">
      <div className="w-full h-[840px] my-custom-bg-class2 bg-cover bg-fixed bg-no-repeat text-white flex flex-col justify-center items-center">
        ...
        <input
          className="w-2/4 p-8 bg-transparent border-[2px] border-solid border-white text-[1.2rem] text-white outline-none placeholder:text-[1.2rem] placeholder:text-[rgba(255,255,255,0.6)]"
          type="text"
