        ...
        <div className="w-full pt-7">
          ...
          <div className="w-full mt-32 flex justify-between">
            <div className="w-5/12">
              <div className="w-full mb-60 flex flex-col items-center hover:text-stroke">
                <img
                ...
                <h1 className="text-[2.625rem] font-semibold">
                  THE <span className="text-white">(더)</span>+이상
                </h1>
                <p>더 이상적인 사회를 만들고자 하는 의미를 가지고 있습니다.</p>
              </div>
