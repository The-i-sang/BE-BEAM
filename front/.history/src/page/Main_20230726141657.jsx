...
export default function Main() {
  return (
    <div className="bg-[#ffeaa6]">
      <div className="w-full h-[800px] pt-32 bg-[url('https://images.unsplash.com/photo-1553877522-43269d4ea984?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80')] bg-cover bg-fixed bg-no-repeat flex justify-center items-center">
