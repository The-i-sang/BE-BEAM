                ...
                >
                  <div className="relative">
                    <img
                      ...
                      alt="toolkit_img"
                    />
                    {focusedItem.id === toolkit.id ? (
                      <div
                        className={`${
                          focusedItem.focused === true ? "h-24" : "h-0"
                        } absolute bottom-0 w-full h-24 bg-[rgba(255,225,129,0.91)] rounded-b-lg flex justify-center items-center text-xl transition-all duration-700 overflow-hidden`}
                      >
                        <p>자세히 보기</p>
                      </div>
                    ) : (
