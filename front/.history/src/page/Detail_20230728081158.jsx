    ...
    <div className="w-full pt-40 pb-28 bg-[#ffffff]">
      <div className="w-11/12 mx-auto py-10 flex justify-between">
        ...
        <div className="w-5/12 text-[#282828]">
          ...
          <div className="w-full py-10 box-border flex justify-between items-center">
            {selectedToolkit && !isNaN(recommendIndex) && (
              <>
                <img
                  className="w-2/12 h-full object-fill"
                  src={
                ...
                <div className="flex flex-col ml-[-17rem]">
                  <p>Another Toolkit Recommendation</p>
                  <p>{selectedToolkit[recommendIndex].title}</p>
                </div>
